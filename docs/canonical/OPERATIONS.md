...
**Last verified against live tree:** 2026-08-03 (v43 THE EVENING RUN — the `/booth` + `/foundation` file-map row rewritten after the shared sheet was extracted; the routing row gained the catch-all)
