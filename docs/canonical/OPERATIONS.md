...
- **`SUNDAY-20260830.md` IS OUTSIDE `docs:numbers:gate`'s DOCUMENT SET AND CARRIES SEVEN PUBLISHED VALUES A COMMIT CAN MOVE, SO THE RULE THAT KEEPS IT TRUE IS PROSE (2026-08-25).** The rule and the value list are boxed at the head of that file.
