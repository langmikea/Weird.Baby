...
can start 09-18  needed by 10-11   14d float   the shape pointed at, from a range: The song's page on /wb, and the caption line that points at it
...
can start 09-18  needed by 10-18   21d float   pointed at, from a palette: The beat under the reels: a palette he can play, then one, The launch run of show: what posts each day 10-26 to 11-13, and where each lands
...
can start 09-20  needed by 10-18   28d float   the look pointed at, from a range: Coconuts, the first run
...
can start 10-20  needed by 10-23    0d float   launch volume in hand: Coconuts, the first run
...
can start 10-22  needed by 10-25    0d float   held: The deploy before the Number
can start 09-19  needed by 10-29    0d float   held: The deploy for the door
```
...
WEEK OF 09-21
  the Sunday sitting, 09-27: point at or rule
    ...
    - pointed at, from a palette: The beat under the reels: a palette he can play, then one, The launch run of show: what posts each day 10-26 to 11-13, and where each lands
...
WEEK OF 10-19
  launch volume in hand: Coconuts, the first run   (a run, from here to 10-23)
  his real material in: The ask reel on MGK-NIAC   (any day to 10-25)
  held: The deploy before the Number   (fixed, 10-25)
WEEK OF 10-26
  held: The deploy for the door   (fixed, 10-29)
```
...
forecast 10-22  needed 10-25    3d  Ops   passed the rehearsal: 7 things (The album template, proven on stand-ins, The feature-page template, ...)
forecast 10-23  needed 10-23    0d  Mike  launch volume in hand: Coconuts, the first run
forecast 10-25  needed 10-25    0d  Mike  held: The deploy before the Number
forecast 10-28  needed 10-25   -3d  Mike  launch volume in hand: The daily Q&A line
forecast 10-29  needed 10-29    0d  Mike  held: The deploy for the door
```
...
10-11  Mike  the shape pointed at, from a range: 4 things (The feature-page template, The prologue, ...)   [can start 09-27, float 14d]
...
10-18  Mike  pointed at, from a palette: The beat under the reels: a palette he can play, then one, The launch run of show: what posts each day 10-26 to 11-13, and where each lands   [can start 09-18, float 21d]
10-18  Mike  the look pointed at, from a range: Coconuts, the first run, The sexy-shoot reel   [can start 09-20, float 28d]
...
### Week of 10-19: Mike 10 asks · Ops 27

```
10-19  Ops   one through the whole pipe on stand-ins: Coconuts, the first run   [can start 09-20, float 28d]
10-20  Ops   one real post through the queue: Coconuts, the first run   [can start 10-13, float 6d]
...
10-20  Ops   one built on stand-ins: 5 things (The feature-page template, The prologue, ...)   [can start 09-27, float 20d]
...
10-23  Mike  launch volume in hand: Coconuts, the first run   [can start 10-20, float 0d]
...
10-23  Ops   ran unattended a week: The morning run, The board and the Sunday exception sitting   [can start 09-18, float 28d]
10-23  Ops   built in: The launch run of show: what posts each day 10-26 to 11-13, and where each lands   [can start 09-27, float 24d]
10-24  Mike  delivered: Words: About the Artist   [can start 09-18, float 35d]
10-24  Ops   built for real: 6 things (The feature-page template, The prologue, ...)   [can start 09-30, float 20d]
...
10-25  Mike  held: The deploy before the Number   [can start 10-22, float 0d]
10-25  Ops   one real post through the queue: The hot Q&A lane, The ask reel on MGK-NIAC   [can start 10-13, float 11d]
10-25  Ops   built in: The beat under the reels: a palette he can play, then one   [can start 09-27, float 26d]
...
10-25  Ops   in the launch build: 7 things (The album template, proven on stand-ins, The feature-page template, ...)   [can start 09-22, float 32d]
10-25  Ops   passed the rehearsal: 7 things (The album template, proven on stand-ins, The feature-page template, ...)   [can start 10-22, float 3d]
...
10-25  Ops   planned on paper: The deploy before the Number   [can start 09-18, float 36d]
...
### Week of 10-26: Mike 1 ask · Ops 1

```
10-29  Mike  held: The deploy for the door   [can start 09-19, float 0d]
10-29  Ops   planned on paper: The deploy for the door   [can start 09-18, float 40d]
```
