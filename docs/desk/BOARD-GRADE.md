...
The system              23%      77%          0%      (7, 0)
```

## Yours, now (three at most)

```
1. Buffer: the accounts, the four channels, the key - yours to do, holds 6; promised 09-18
2. answer length: the glass fit is unruled (Sunday Q1) - one answer, holds 1; promised 09-20
3. the frame, from the A/B already cut (Sunday Q7) - one answer, holds 1; promised 09-20
```
