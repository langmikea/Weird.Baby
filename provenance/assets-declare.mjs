...
/* [2026-09-11] THE CHARACTER ALBUM COVERS — stand-ins, Mike's ruling A of 09-11: the
   box for the Everyday from the one B&W sample that survived the deletion of the tray
   originals, the ring empty on the other three until the colour shoot. Built by
   tools/make_album_covers.py on make_unit_covers.py's geometry; parked under
   public/held/ (the STAGE hold) and declared at the public address. */
const STANDIN_COVER = "generated by tools/make_album_covers.py on the machine covers' own geometry (tools/make_unit_covers.py); a stand-in until the colour shoot of the artifact";
const A = [
  ["/robots/art/album-everyday-cover.png", "HOUSE", STANDIN_COVER, true,
    "THE EVERYDAY · THE BOX · STAND-IN UNTIL THE COLOUR SHOOT — house lettering; the disc is the B&W sample of the box on the tray.", "2026-09-11 — read off the file at full resolution"],
  ["/robots/art/album-gambler-cover.png", "HOUSE", STANDIN_COVER, true,
    "THE GAMBLER · THE CASE · PHOTOGRAPH TO COME — house lettering, ring empty.", "2026-09-11 — read off the file at full resolution"],
  ["/robots/art/album-ceo-cover.png", "HOUSE", STANDIN_COVER, true,
    "THE CEO · THE ATTACHÉ · PHOTOGRAPH TO COME — house lettering, ring empty.", "2026-09-11 — read off the file at full resolution"],
  ["/robots/art/album-informer-cover.png", "HOUSE", STANDIN_COVER, true,
    "THE INFORMER · THE SPY KIT · PHOTOGRAPH TO COME — house lettering, ring empty.", "2026-09-11 — read off the file at full resolution"],
