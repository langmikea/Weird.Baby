...
<p class="sub">Three lanes: the Record, which the site posts; the Determination, which you post, one reel a weekday from the day the machine is shown; and the Number, a live musical number a weekday, its own post. Your rulings of 2026-09-02 and 2026-09-03; since the reset of 2026-09-10 both reel lanes start with the launch run, the week of 10-26, and rows before it are held. Posts go at ${esc(cal.post_time)}. What posts in a week is prepared by the Friday before. Ask and it answers: <code>npm run calendar</code>. Ops keeps it current; you never edit it.</p>
