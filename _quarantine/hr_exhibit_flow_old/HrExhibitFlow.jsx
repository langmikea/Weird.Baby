...
function ExhibitScroller({ items, activeAlbumId, children }) {
  ...
  const startTimer = useCallback(() => {
    ...
    timerRef.current = setInterval(() => {
      ...
      // Don't auto-advance away from YouTube embeds — visitor might be watching
  ...
  return (
    ...
    >
      ...
      <div className="ef-strip">
        ...
        <div className="ef-center" onClick={() => !current.ytId && setLightbox(current)}>
          {current.ytId ? (
            ...
            <div className="ef-card ef-card-fb" style={{ background: "#1877f2", borderRadius: "2px", overflow: "auto", maxHeight: "500px", display: "flex", alignItems: "center", justifyContent: "center", padding: "8px" }}>
              <FacebookEmbed url={current.postUrl} width={480} />
            </div>
          ) : (
      ...
      {/* Caption — always visible below card */}
      ...
      {/* Slot for pills — tucked under the card */}
      {children}
